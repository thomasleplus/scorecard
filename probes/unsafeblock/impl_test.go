...
func Test_Run(t *testing.T) {
	...
	tests := []struct {
			...
			expected: []finding.Finding{
				{
					...
					Location: &finding.Location{Path: "unsafe-sun.java", LineStart: toUintPointer(3)},
				},
			},
			err: nil,
		},
		{
			name: "Java - unsafe in jdk.internal.misc",
			repoLanguages: []clients.Language{
				{Name: clients.Java, NumLines: 0},
			},
			filenames: []string{
			...
			expected: []finding.Finding{
				{
					...
					Location: &finding.Location{Path: "unsafe-jdk.java", LineStart: toUintPointer(3)},
				},
			},
			err: nil,
		},
		{
			name: "Java - unsafe with safe",
			repoLanguages: []clients.Language{
				{Name: clients.Java, NumLines: 0},
			},
			filenames: []string{
		...
		{
			name: "Java - malformed file with unsafe",
			repoLanguages: []clients.Language{
				{Name: clients.Java, NumLines: 0},
			},
			filenames: []string{
			...
			expected: []finding.Finding{
				{
					Probe:    Probe,
					Message:  "malformed Java file",
					Outcome:  finding.OutcomeError,
					Location: &finding.Location{Path: "malformed.java"},
				},
				{
					Probe:   Probe,
					Message: "Java code uses the Unsafe class",
					...
					Location: &finding.Location{Path: "unsafe-misc.java", LineStart: toUintPointer(3)},
				},
				{
					Probe:   Probe,
					Message: "Java code uses the Unsafe class",
